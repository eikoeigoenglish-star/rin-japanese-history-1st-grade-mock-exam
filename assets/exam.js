const AVAILABLE_MOCKS = [
  ...
  { id: '003', file: 'mock003.json', label: '第3回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '004', file: 'mock004.json', label: '第4回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '005', file: 'mock005.json', label: '第5回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '006', file: 'mock006.json', label: '第6回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '007', file: 'mock007.json', label: '第7回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '008', file: 'mock008.json', label: '第8回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '009', file: 'mock009.json', label: '第9回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '010', file: 'mock010.json', label: '第10回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '011', file: 'mock011.json', label: '第11回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '012', file: 'mock012.json', label: '第12回模試', note: '30問 / 4択20・記述8・論述2' },
  { id: '013', file: 'mock012.json', label: '第13回模試', note: '30問 / 4択20・記述8・論述2' }
];
